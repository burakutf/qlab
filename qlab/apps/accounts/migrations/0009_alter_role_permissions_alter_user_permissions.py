...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0008_alter_role_permissions_alter_user_permissions'),
    ]
            ...
            field=qlab.apps.core.models.ChoiceArrayField(
                base_field=models.CharField(
                    choices=[
                        ...
                        ('user_detail.create', 'KULLANICI DETAY OLUŞTUR'),
                        ('user_detail.update', 'KULLANICI DETAY GÜNCELLE'),
                        ('user_detail.view', 'KULLANICI DETAY GÖRÜNTÜLE'),
                        ...
                        ('org_info.create', 'ORGANİZASYON BİLGİSİ OLUŞTUR'),
                        ('org_info.view', 'ORGANİZASYON BİLGİSİ GÖRÜNTÜLE'),
                        ('org_info.update', 'ORGANİZASYON BİLGİSİ GÜNCELLE'),
                        ('org_info.destroy', 'ORGANİZASYON BİLGİSİ SİL'),
                        ...
                        ('work_order.create', 'İŞ EMRİ OLUŞTUR'),
                        ('work_order.view', 'İŞ EMRİ GÖRÜNTÜLE'),
                        ('work_order.update', 'İŞ EMRİ GÜNCELLE'),
                        ('work_order.destroy', 'İŞ EMRİ SİL'),
                    ],
                    max_length=32,
                ),
                blank=True,
